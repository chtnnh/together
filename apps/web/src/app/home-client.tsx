...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Members request tracks; hosts promote to the DJ queue. Import from YouTube URLs, search, Spotify, or Apple Music.",
  },
  {
    icon: Vote,
    title: "Vote to skip",
  ...
  },
  {
    ...
    description:
      "Spotify and Apple tracks resolve to YouTube via ISRC lookup and fuzzy title matching, with alternate picks.",
  },
  {
    icon: ThumbsUp,
